...
export const projects = [
  {
    ...
    title: 'ClearOne Advantage',
    subtitle: 'Frontend & Voice Lead — Senior Capstone',
    ...
    team: "USF Senior Capstone Team (Divya D'Souza, Natalie Hlusi, Manasa Krishnan, Ankit Mukhopadhyay), ClearOne Advantage team and sponsors",
  ...
  },
  {
    slug: 'llm-evaluation',
    title: 'Orchestro.ai',
    subtitle: 'LLM Evaluation Pipeline',
    ...
    role: 'AI Software Engineering and Research Intern',
